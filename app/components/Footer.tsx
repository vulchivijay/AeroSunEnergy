            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-gray-900 hover:text-primary transition-colors dark:text-gray-300 dark:hover:text-primary"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <a
                ...
                aria-label="Twitter"
                className="p-2 rounded-md bg-gray-900 hover:bg-primary transition-colors"
              >
            ...
            {/* QR Code */}
            <div className="bg-white rounded-xl shadow-xl border border-gray-200 hover:shadow-xl transition-shadow inline-block dark:bg-slate-800 dark:border-gray-600">
              <Image
                ...
                className="w-50 h-50"
              />
              <p className="text-center text-md text-gray-600 mt-1 font-semibold dark:text-gray-300">Scan</p>
            </div>
          </div>
        </div>
      </div>
