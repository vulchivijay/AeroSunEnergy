...
const stepStyles = [
  { icon: '📍', imageSrc: '/images/forming-aerosunenergy.png', imageAlt: 'Site assessment and planning process by AeroSun Renewable Energy', color: 'from-primary to-blue-400', cardBg: 'bg-blue-100/90 dark:bg-blue-900/55 border-blue-300 dark:border-blue-700', iconBg: 'bg-blue-300 dark:bg-blue-800', nodeBg: 'from-blue-700 to-blue-500' },
  { icon: '📐', imageSrc: '/images/customdesign-aerosunenergy.png', imageAlt: 'Custom hybrid system design by AeroSun Renewable Energy', color: 'from-secondary to-teal-400', cardBg: 'bg-emerald-100/90 dark:bg-emerald-900/55 border-emerald-300 dark:border-emerald-700', iconBg: 'bg-emerald-300 dark:bg-emerald-800', nodeBg: 'from-emerald-700 to-teal-500' },
  ...
  { icon: '📊', imageSrc: '/images/smart-vawt-aerosunenergy.png', imageAlt: 'Smart monitoring dashboard for AeroSun Renewable Energy systems', color: 'from-primary to-secondary', cardBg: 'bg-violet-100/90 dark:bg-violet-900/55 border-violet-300 dark:border-violet-700', iconBg: 'bg-violet-300 dark:bg-violet-800', nodeBg: 'from-violet-700 to-purple-500' },
...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="px-6 sm:px-3 lg:px-12 py-16 md:py-24 bg-gray-50 dark:bg-gray-900 overflow-hidden">
