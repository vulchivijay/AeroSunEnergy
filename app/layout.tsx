...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'No 1 hybrid solar wind energy',
    'No 1 solar and wind energy solutions',
    'No 1 hybrid energy systems for homes and businesses',
    'No 1 smart energy systems with IoT monitoring',
    'No 1 cost-saving renewable energy solutions',
    'No 1 eco-friendly energy solutions',
    'No 1 low maintenance energy systems',
    'No 1 efficient space-saving energy solutions',
  ],
